...
/* Today's date. */
let today: moment.Moment = moment().startOf('day').utc();
/* Tomorrow's date. */
let tomorrow: moment.Moment = moment().startOf('day').add(1, 'days').utc();
/* Two days from today. */
let twoDaysFromToday: moment.Moment = moment().startOf('day').add(2, 'days').utc();
/* Yesterday's date. */
let yesterday: moment.Moment = moment().startOf('day').subtract(1, 'days').utc();
...
export const TASKS: any[] = [
    ...
    },
    {
        ...
        description: 'Create a client side angular application for managing tasks', 
    ...
    },
    {
        ...
        description: 'Create the services required to share data between components', 
        dueDate: today.toDate(), 
        dateCompleted: today.toDate(), 
        isComplete: true, 
        priority: "High"
    ...
    {
        name: 'Create Services', 
        description: 'Create services for handling business logic with API requests', 
        dueDate: today.toDate(), 
        dateCompleted: today.toDate(), 
        isComplete: true, 
        priority: "Medium"
    ...
    {
        name: 'Add Bootstrap', 
        description: 'Add class to bootstrap the server and all required middleware', 
        dueDate: today.toDate(), 
        dateCompleted: null, 
        isComplete: false, 
        priority: "Medium"
    ...
    {
        name: 'Compodoc',
        description: 'Add compodoc to generate documentation for angular client',
        dueDate: twoDaysFromToday.toDate(),
        dateCompleted: null,
        isComplete: false,
        priority: "Low"
    ...
    {
        name: 'Docker',
        description: 'Add Docker files to generate images for client and server containers',
        dueDate: twoDaysFromToday.toDate(),
        dateCompleted: null,
        isComplete: false,
        priority: "Low"
    ...
    {
        name: 'Compose Files',
        description: 'Add compose file to define services, networks, and volumes for client and server containers',
        dueDate: twoDaysFromToday.toDate(),
        dateCompleted: null,
        isComplete: false,
        priority: "Low"
    },
    {
        ...
        dueDate: moment('10/1/2018', 'MM/D/YYYY', true).startOf('day').utc().toDate(),
        dateCompleted: null,
        isComplete: false,
        priority: "Medium"
    },
    {
        ...
        dueDate: moment('1/10/2019', 'M/DD/YYYY', true).startOf('day').utc().toDate(),
        dateCompleted: null,
        isComplete: false,
        priority: "Medium"
    },
    {
        ...
        dueDate: moment('1/1/2019', 'M/D/YYYY', true).startOf('day').utc().toDate(),
        dateCompleted: null,
        isComplete: false,
        priority: "Medium"
    }
